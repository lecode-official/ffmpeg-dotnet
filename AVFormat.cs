...
namespace System.Media.FFmpeg.Interop
{
    ...
    public class AVFormat
    {
        ...
        /// Pointer to the user-supplied AVFormatContext (allocated by avformat_alloc_context). May be a pointer to <c>null</c>, in which case an <see cref="AVFormatContext"/> is allocated by this function and written into <see cref="ps"/> Note that
        /// a user-supplied <see cref="AVFormatContext"/> will be freed on failure.
        /// </summary>
        ...
        /// <param name="options">A dictionary filled with <see cref="AVFormatContext"/> and demuxer-private options. On return this parameter will be destroyed and replaced with a dictionary containing options that were not found. May be <c>null</c>.</param>
